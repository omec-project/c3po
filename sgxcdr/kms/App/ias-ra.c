 ...
 )
{
    ...
    if(curl) {
        ...
        unsigned char json[quote_size * 2];

        int ret = EVP_EncodeBlock(quote_base64, (unsigned char*) quote, quote_size);
